...
u8 RTC_Init(void)
{
    ...
    RTC_Handler.Init.AsynchPrediv = 0X7C;         //RTC异步分频系数(1~0X7F)   1s=25M/25/(7C+1)/(1f3f+1)
    RTC_Handler.Init.SynchPrediv = 0X1F3F;          //RTC同步分频系数(0~7FFF)
...
void RTC_Set_WakeUp(u32 wksel, u16 cnt)
{
    ...
    HAL_NVIC_SetPriority(RTC_WKUP_IRQn, 0x01, 0x02); //抢占优先级1,子优先级2
